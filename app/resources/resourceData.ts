...
export const RESOURCE_PAGES: ResourcePage[] = [
  {
    ...
    "intro": "Welcome to the Cafe Value resource centre. This is the no-stress corner for shoppers who want the menu to make sense before they visit. Pick the product lane, compare what matters, then use the current menu or staff for details that change.",
    "cards": [
      {
        "title": "Menu Guide",
    ...
    "sections": [
      ...
      },
      {
        ...
        "body": "Cafe Value serves shoppers around The Annex / Spadina, Spadina Ave, The Annex, Bloor St W. If you searched for a weed dispensary in The Annex / Spadina, this resource section keeps the visit simple: right store, right menu lane, right next step."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "description": "Compare exotic flower, premium flower, budget weed, cheap weed, and affordable weed at Cafe Value without guessing.",
