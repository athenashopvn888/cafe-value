...
export const metadata: Metadata = {
  title: "FAQ — Cafe Value | Toronto Dispensary Questions",
  description:
    "Frequently asked questions about Cafe Value in Toronto. Hours, location, products, pricing, bundle offers, and everything you need to know before visiting.",
};
...
const FAQ_CATEGORIES = [
  {
    ...
    faqs: [
      { q: "Where is Cafe Value located?", a: "We are located at 654 Spadina Ave, Toronto, ON M5S 2H7 — in the heart of Spadina. We're near the Eaton Centre, CN Tower, and major OC Transpo bus routes." },
      { q: "What are your hours?", a: "We are open 10:00 AM - 10:00 PM a day, 7 days a week, 365 days a year. Walk in anytime — no appointment needed." },
      ...
      { q: "What's the best way to get to Cafe Value?", a: "We're easily accessible by car, bus, or foot. From Eaton Centre, walk north on Center St — we're a 5-minute walk. By bus, several OC Transpo routes stop within walking distance. Free evening parking is available on surrounding streets." },
    ],
  },
  {
    title: "🌿 Products & Menu",
    faqs: [
      ...
      { q: "Do you have a live menu?", a: "Yes! Our online menu at cafevaluecannabisdispensary.com updates in real time with current stock, prices, THC levels, and availability. You can check what's in stock before you visit." },
  ...
  },
  {
    ...
    faqs: [
      { q: "Do I need an appointment?", a: "No! Cafe Value is walk-in only. Just show up anytime — we're open 10:00 AM - 10:00 PM." },
      { q: "Can I order online?", a: "Currently, Cafe Value is an in-store shopping experience only. You can browse our live menu online to see what's in stock before visiting." },
      ...
      <main className={styles.main}>
        ...
        <div className={styles.content}>
          ...
          <p className={styles.pageSubtitle}>
            Everything you need to know about Cafe Value — Toronto&apos;s premium dispensary at 654 Spadina Ave in Spadina.
          </p>
