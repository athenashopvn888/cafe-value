...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  EDIBLES: {
    ...
    seoDescription: "Edibles shop best when you compare the exact listing instead of guessing from an old example. Use the current menu at Cafe Value for names, package details, posted prices, and staff help when needed.",
    faqs: [
      { q: "What edibles are listed at Cafe Value?", a: "Use the current menu to compare edible names, package details, prices, and item notes." },
  ...
  "VAPE PENS": {
    ...
    seoTitle: "Nicotine Vapes Toronto | Cafe Value Cannabis",
    seoIntro: "Explore Cafe Value Cannabis nicotine vape products in a category kept separate from THC Vape products. Nicotine products are for adults 19+ and contain nicotine, which is addictive.",
  ...
  "MAGIC & OTHERS": {
    ...
    seoTitle: "Specialty Items | Cafe Value",
    seoIntro: "Browse specialty items only where they are listed on the current Cafe Value menu.",
