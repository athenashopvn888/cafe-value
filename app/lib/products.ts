...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  EDIBLES: {
    ...
    seoIntro: "Browse the full cannabis edibles menu at Cafe Value on Center St, Toronto. We carry THC gummies, chocolates, drinks, and more from top Canadian brands.",
    seoDescription: "Looking for cannabis edibles in Toronto? Cafe Value stocks a wide range of THC-infused gummies, chocolates, beverages, and baked goods. Our edibles range from micro-dose options for beginners to high-potency products for experienced consumers. All products are lab-tested and sourced from licensed Canadian producers. Visit us at 654 Spadina Ave — open daily 10:00 AM - 10:00 PM.",
    ...
    faqs: [
      ...
      { q: "Can I buy edibles at Cafe Value?", a: "Yes! Visit us at 654 Spadina Ave, Toronto. We're open daily 10:00 AM - 10:00 PM with a full edibles selection in store." },
    ],
  },
  "VAPE PENS": {
    name: "Vape Pens", slug: "vapes", color: "#8b5cf6", icon: "💨",
    seoTitle: "Vape Pens Toronto — THC & Nicotine Cartridges",
    seoIntro: "Shop THC and nicotine vape pens at Cafe Value, Toronto. Cartridges, 510-thread batteries, and premium vape brands — all in stock.",
    seoDescription: "Cafe Value carries a curated selection of vape pens and cartridges in Toronto. From 510-thread THC cartridges to nicotine vape pods, we stock the most popular brands and flavours. Our knowledgeable budtenders can help you choose the right cartridge and battery setup. Visit us at 654 Spadina Ave for the best vape selection in Spadina.",
  ...
  "VAPE DISPOSABLE": {
    ...
    seoIntro: "THC disposable vapes available at Cafe Value, Toronto. No charging, no refilling — just open and enjoy.",
    seoDescription: "Disposable THC vapes are the easiest way to enjoy cannabis on the go. Cafe Value stocks a wide selection of pre-charged, pre-filled disposable vape pens with various strain profiles and potencies. Perfect for beginners and experienced users alike. Visit us at 654 Spadina Ave, Toronto.",
  ...
  CONCENTRATES: {
    ...
    seoIntro: "Premium cannabis concentrates at Cafe Value, Toronto. Shatter, wax, hash, live resin, and diamonds — all in stock.",
    seoDescription: "Cafe Value offers a premium selection of cannabis concentrates in Toronto. From traditional hash and kief to modern extracts like shatter, wax, live resin, and THC diamonds, we carry products for every preference and potency level. Our concentrates are sourced from trusted extractors and tested for purity. Visit us at 654 Spadina Ave.",
  ...
  PREROLLS: {
    ...
    seoIntro: "Pre-rolled cannabis joints at Cafe Value, Toronto. Singles, multi-packs, and infused pre-rolls — ready to light up.",
    seoDescription: "Skip the rolling and grab a pre-roll from Cafe Value in Toronto. We carry singles, multi-packs, and infused pre-rolls from premium flower. Whether you want a quick smoke or a party pack, our pre-roll selection has something for everyone. Visit us at 654 Spadina Ave — open daily 10:00 AM - 10:00 PM.",
    banner: "/banners/cafe-value-prerolls.png",
    faqs: [
  ...
  "ADD ONS": {
    ...
    seoIntro: "Essential cannabis accessories at Cafe Value, Toronto. Grinders, rolling papers, lighters, trays, and more.",
    seoDescription: "Cafe Value carries all the accessories you need for the perfect smoke session. From premium grinders and rolling papers to lighters, trays, and storage containers, we have everything in stock. Visit us at 654 Spadina Ave, Toronto.",
  ...
  CIGARETTES: {
    ...
    seoTitle: "Native Cigarettes Toronto — Discount Tobacco at Cafe Value",
    seoIntro: "Discount native cigarettes at Cafe Value, Toronto. Premium and value brands at the best prices on Center St.",
    seoDescription: "Cafe Value is your go-to source for affordable native cigarettes in Toronto. We carry a wide selection of premium and value tobacco brands at competitive prices. Located at 654 Spadina Ave in the heart of Spadina, we're open daily 10:00 AM - 10:00 PM. Stop by for the best cigarette prices in the neighbourhood.",
    banner: "/banners/cafe-value-cigarettes.png",
    faqs: [
      { q: "Do you sell cigarettes at Cafe Value?", a: "Yes! We carry a wide selection of native cigarette brands at competitive prices." },
