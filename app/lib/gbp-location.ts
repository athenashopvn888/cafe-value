...
export const gbpLocation = {
  ...
  hours: ["Daily: 10:00 AM - 12:00 AM (midnight). Not 24 hours."],
  seoTitle: "Cafe Value Cannabis | Annex Spadina Dispensary",
  metaDescription: "Cafe Value Cannabis is the Annex walk-in at 654 Spadina Ave. Open daily 10:00 AM – 12:00 AM (not 24 hours). Flower, pre-rolls, edibles, vapes. Adults 19+.",
