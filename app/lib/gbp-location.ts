...
export const gbpLocation = {
  ...
  hours: ["This location has closed and moved to Green Sundae in Mississauga"],
  seoTitle: "Cafe Value Cannabis | Annex Spadina Dispensary",
  metaDescription: "Cafe Value Cannabis is the Annex walk-in at 654 Spadina Ave. This location has closed and moved to Green Sundae in Mississauga. Flower, pre-rolls, edibles, vapes. Adults 19+.",
