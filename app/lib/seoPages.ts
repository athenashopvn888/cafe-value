...
export const SEO_PAGES: SeoPageData[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Cafe Value is more than just a flower shop. We carry a comprehensive selection of cannabis edibles (gummies, chocolates, baked goods), vape pens and disposable vapes, concentrates (shatter, wax, hash, diamonds, live resin), pre-rolled joints, native cigarettes, rolling papers, and accessories. Our live digital menu at cafevaluecannabisdispensary.com updates in real time so you always know exactly what's in stock before you make the trip.",
      },
      {
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "When you make the trip across the bridge, make it count. Cafe Value carries a full selection including 200+ flower strains, edibles, vape pens, disposable vapes, concentrates (shatter, wax, hash, live resin), pre-rolled joints, native cigarettes, and accessories. Check our live online menu at cafevaluecannabisdispensary.com before you visit to see exactly what's in stock.",
      },
    ],
    faqs: [
