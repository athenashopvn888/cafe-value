...
Open the store page, browse the available menu/category sections, and use the contact or directions options when you are ready to plan your visit.`,
  ...
  },
  {
    ...
    title: "Cafe Value Cannabis Price And Flower Tier Guide for Adults 19+",
    seoTitle: "Cafe Value Cannabis Price Tier Guide | Adult 19+",
    seo_title: "Cafe Value Cannabis Price Tier Guide | Adult 19+",
    metaDescription: "Adult 19+ guide to Cafe Value Cannabis flower tiers, weight choices, unit value, and store visit planning in Toronto.",
    meta_description: "Adult 19+ guide to Cafe Value Cannabis flower tiers, weight choices, unit value, and store visit planning in Toronto.",
    h1: "Cafe Value Cannabis Price And Flower Tier Guide for Adults 19+",
    excerpt: "A simple adult 19+ guide to Cafe Value Cannabis flower tiers, weights, and unit value.",
    author: "The Cafe Value Cannabis Team",
    date: "2026-07-09",
    category: "Price Guide",
    readTime: "4 min",
    content: `## Cafe Value Cannabis Price And Flower Tier Guide for Adults 19+

Cafe Value Cannabis keeps flower browsing simple for adults 19+ by organizing options into clear price and quality tiers. Instead of guessing where to start, shoppers can pick the grade they want first, then choose the weight that fits the visit and budget.
...
For the smoothest visit, open the Cafe Value Cannabis menu before heading out. The live menu is the best place to compare current categories, weights, and store-specific options. The store page is also useful for directions, contact details, and quick visit planning.
...
- Browse the Cafe Value Cannabis store page for directions, contact details, and visit planning.
...
This guide is for adults 19+ who want a simple way to understand Cafe Value Cannabis flower tiers before visiting.`,
    faq: "",
    internal_links_used: "[Cafe Value Cannabis store page](/weed-dispensary-toronto)\\n[Cafe Value Cannabis homepage](/)\\n[More Cafe Value Cannabis guides](/blog)",
    relatedLinks: [
      {
