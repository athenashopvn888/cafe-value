...
export const metadata: Metadata = {
  title: "Delivery Menu | Cafe Value",
  description: "Browse the Cafe Value delivery product catalog and compare flower tiers and prices.",
  alternates: { canonical: "https://www.cafevaluecannabisdispensary.com/delivery" },
};

export default function DeliveryPage() {
  const structuredData = { "@context": "https://schema.org", "@type": "CollectionPage", name: "Cafe Value Delivery Menu", url: "https://www.cafevaluecannabisdispensary.com/delivery", mainEntity: { "@type": "ItemList", numberOfItems: menu.products.length, itemListElement: menu.products.map((product, index) => ({ "@type": "ListItem", position: index + 1, name: product.name })) } };
