...
export default function DeliveryContent() {
  ...
  return <main className={styles.main}>
    ...
    <div className={styles.ctaSection}><p>Visit us in-store at <strong>654 Spadina Ave, Toronto, ON M5S 2H7</strong> in The Annex. We are open <strong>10:00 AM - 12:00 AM</strong> (not 24 hours). Call <strong>+1 (289) 807-4161</strong>.</p></div>
