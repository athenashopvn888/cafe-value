...
export default function DeliveryContent() {
  ...
  return <main className={styles.main}>
    ...
    <section className={`${styles.hero} ${styles.heroPlain}`}>
      <div><p>Cafe Value Cannabis · 654 Spadina Ave · The Annex</p><h1>Weed Delivery Menu</h1><span>Browse the catalog from the Spadina walk-in. The dispatcher confirms current availability and whether a drop-off is inside this store&apos;s radius before an order is accepted. This is not a city-wide Toronto delivery farm.</span></div>
    </section>
    ...
    <div className={styles.ctaSection}><p>Visit us in-store at <strong>654 Spadina Ave, Toronto, ON M5S 2H7</strong> in The Annex. This location has closed and moved to Green Sundae in Mississauga. Call <strong>+1 (289) 807-4161</strong>.</p></div>
