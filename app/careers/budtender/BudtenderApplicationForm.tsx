...
const requiredFields = [
  ...
  { name: "WhyQLC", label: "Why you want to work at Cafe Value" },
...
export default function BudtenderApplicationForm() {
  ...
  return (
    <form className={styles.applicationForm} onSubmit={handleSubmit} noValidate>
      <input type="hidden" name="StoreKey" value="CVC01" />
      <input type="hidden" name="StoreName" value="Cafe Value" />
      ...
      <div className={styles.formSection}>
        ...
        <label className={styles.field}>
          <span>Why do you want to work at Cafe Value?</span>
